...
import type { WeArePlanetSdkException } from "./WeArePlanetSdkException";
...
export class SdkExceptionErrorCodes {
   ...
   */
  public static is(exception: WeArePlanetSdkException, errorCode: SdkExceptionErrorCodes): boolean {

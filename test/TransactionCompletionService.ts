    ...
    */
    describe('completeOffline', () => {
        it('completeOffline successful', () => {
            ...
            let transactionCompletion: WeArePlanet.model.TransactionCompletion;
            ...
            .delay(7500)
            .done((response: { response: http.IncomingMessage, body: WeArePlanet.model.TransactionCompletion }) => {
                transactionCompletion = response.body;
                expect(transactionCompletion.state).to.equal(WeArePlanet.model.TransactionCompletionState.SUCCESSFUL);
            });
        });
    });
